...
import com.github.frcsty.districtcore.plugins.collectors.collector.object.CollectorBuilder;
...
class ConfirmationMenu {
    ...
    static Gui getConfirmationMenu(final DistrictCore core, final CollectorsPlugin plugin, final Block block) {
        final ConfigurationSection section = core.getSectionLoader().getSection("collector").getConfigurationSection("confirmation-menu");
