package com.github.frcsty.districtcore.plugins.elixirs.elixir;
...
public class ElixirStorage {
    ...
    public final void loadElixirs(final DistrictCore core) {
        final ConfigurationSection elixirs = core.getSectionLoader().getSection("elixirs");
        ...
        for (String e : elixirs.getKeys(false)) {
            final ConfigurationSection elixir = elixirs.getConfigurationSection(e);
