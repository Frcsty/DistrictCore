...
public class EntityHider implements Listener {
     ...
     */
    private boolean setVisibility(final Player observer, final int entityID, final boolean visible) {
        switch (policy) {
            case BLACKLIST:
     ...
     */
    private boolean isVisible(final Player observer, final int entityID) {
     ...
     */
    private void removeEntity(final Entity entity, final boolean destroyed) {
     ...
     */
    private boolean showEntity(final Player observer, final Entity entity) {
