...
public class ObjectStorage {
    ...
    public final void loadSpawnEggs(final DistrictCore core) {
        final ConfigurationSection spawnEggs = core.getConfig().getConfigurationSection("ceggs");
        ...
        for (String cegg : spawnEggs.getKeys(false)) {
            final ConfigurationSection ceggSection = core.getConfig().getConfigurationSection("ceggs." + cegg);
